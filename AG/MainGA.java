...
public class MainGA {
    ...
    public static void main(String[] args) {
        try {
            ...
            // ===== GA =====
            PlanificadorGenetico planificador = new PlanificadorGenetico(
                grafo,
                30,     // población
                60,     // generaciones
                0.85,   // cruzamiento
            ...
            for (int i = 0; i < solicitudes.size(); i++) {
                ...
                Ruta mejorRuta = planificador.findBestRoute(solicitud);

                System.out.println("\n=== Solicitud " + (i + 1) + " ===");
                System.out.println("Origen: " + solicitud.getOrigin().getCodigo() +
                        " | Destino: " + solicitud.getDestination().getCodigo());

                if (mejorRuta != null && mejorRuta.isFeasible()) {
                    resueltas++;
    ...
    private static Grafo cargarVuelos(Path archivo, Map<String, Aeropuerto> mapa) throws Exception {
        ...
        for (String linea : lineas) {
            ...
            grafo.addFlight(new Vuelo(desde, hasta, tiempo, capacidad));
        }
